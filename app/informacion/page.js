...
export default function SobreNosotros() {
    return (
        ...
        <Container maxWidth="md" sx={{ py: 5 }}>
                        <div className="mt-5">
                <Typography variant="h6" align="center" fontWeight="bold" className="text-text tracking-tighter mb-2">
        ...
        <Timeline position="alternate" sx={{ display: "flex", flexDirection: "column" }}>
            {/* Primer Hito */}
            <TimelineItem className="md:flex md:items-center md:even:flex-row-reverse">
                <TimelineSeparator>
                ...
                <TimelineContent className="w-full md:w-1/2">
